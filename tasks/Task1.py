...
#Converting the image into HSV for better color detection
hsvimg = cv.cvtColor(img, cv.COLOR_BGR2HSV)

#Creating a mask for blue, to seperate the ocean using the upper and lower boundary values for the color in hsv
lower_blue = np.array([90, 50, 50]) #It is worth nothing that the hue in opencv is 0-180 and not 0-360
